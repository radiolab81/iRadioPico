...
Die Funktionen loop() und loop1() sind Dauerschleifen, die nach den jeweiligen setup's, bis zur Trennung der Spannungsversorgung durchlaufen werden. Hier erfolgt die eigentliche Datenverarbeitung , getrennt nach Core0 und Core1.
